    ...
    <div class="container pb-5">
      ...
      <div>
          <?php
            ...
            echo ("<h5>Массив с именами ключей: </h5>");
            foreach($cust as $item => $item_value)
            {
            ...
            $cust["rating"] = 100;
            echo ("<h5 class='mt-3'>Добавлен ключ rating со значением 100: </h5>");
            foreach($cust as $item => $item_value)
            {
              echo "$item = $item_value <br>";
            }
            ...
            echo ("<h5 class='mt-3'>Сортировка массива: </h5>");
            ksort($cust);
            foreach($cust as $item => $item_value)
            {
              echo "$item = $item_value <br>";
            ...
            echo ("<h5 class='mt-3'>Сортировка массива функцией sort(). Ключи поменялись на числовые значения(индексы): </h5>");
            sort($cust);
            foreach($cust as $item => $item_value)
            {
              echo "$item = $item_value <br>";
