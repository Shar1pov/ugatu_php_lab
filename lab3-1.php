    ...
    <div class="container pb-100px">
      ...
      <div class="answer-block">
       <?php
        ...
        echo ('<h5 class="mt-3">a = ' .$a.'</h5>');
       
        echo ('<h5 class="mt-3">b = ' .$b.'</h5>');
       
        if ($a == $b)
            echo ('<h5 class="mt-3">Числа a и b равны</h5>');
        elseif ($a > $b)
            echo ('<h5 class="mt-3"> Число a > b</h5>');
        else
            echo ('<h5 class="mt-3">Число b > a</h5>');
        ?>
        
      </div>
      <a href="lab3-1.html" class="btn btn-outline-secondary btn-md px-4 mt-3">Вернуться назад</a>
    </div>
