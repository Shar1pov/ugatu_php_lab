    ...
    <div class="container pb-200px  mt-100px">
      <div class="tables-item pb-5">
        <?php
          ...
          $password_db = $st['password'];
          $name_db = $st['name'];
        
          }
          echo("<h2>Редактирование пользователя ".$name_db."</h2>");
          ?>
          
        <form action="save_personal.php" method="GET">
          ...
          <button type="submit" class="btn btn-primary mt-3" name="save_personal">Изменить</button>
