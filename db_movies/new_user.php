  ...
  <body>
    ...
    <div class="container pb-200px  mt-100px">
      <div class="tables-item pb-5">
        ...
        <form action="save_new_user.php" method="GET">
          <div class="form-group mt-3">
            <label>Имя</label>
            <input type="text" class="form-control" placeholder="Введите логин" name="name" required>
          </div>  
          <div class="form-group  mt-3">
            <label>Логин</label>
            <input type="text" class="form-control" placeholder="Введите логин" name="username" required>
          </div>
          <div class="form-group mt-3">
            <label>Пароль</label>
            <input type="text" class="form-control" placeholder="Введите пароль" name="password" required>
          </div>
          <div class="form-group mt-3">
          ...
          <button type="submit" class="btn btn-primary mt-3" name="create_movie">Создать пользователя</button>
