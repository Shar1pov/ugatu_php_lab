    ...
    <div class="container pb-200px">
      <div class="tables-item pb-5">
        <?php
          ...
          echo "<p><a href=\"personal.php\"> Вернуться к редактированию личных данных </a>"; 
          }
          else { 
            echo "Пользователь с таким логином уже создан! <a href=\"personal.php\"> Вернуться к созданию нового пользователя </a>"; }
        ?> 
