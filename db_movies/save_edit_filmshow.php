  ...
  <body>
    ...
    <div class="container pb-200px">
      <?php
        ...
        $update="UPDATE filmshow SET timeshow='" . $_GET['timeshow']
          ."', id_movie='".$_GET['movie_select']."', id_cinema='"
          .$_GET['cinema_select']."', places='".$_GET['places'].
          "', booked_places='".$_GET['booked_places']. "' WHERE id_filmshow=" . $_GET['id_filmshow'];
          mysqli_query($conn, $update); 

          if (mysqli_affected_rows($conn)>0) {
          echo "<p>Запись сохранена!";
          echo "<p><a href=\"index.php\"> Вернуться к списку </a>"; 
          }
          else { 
